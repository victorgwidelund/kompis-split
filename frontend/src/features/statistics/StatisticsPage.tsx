...
export function StatisticsPage({ data, onBack, onRefresh }: { data: StatisticsResponse; onBack: () => void; onRefresh: () => void }) {
  ...
  return <section className="statistics-view">
    ...
    </div><p className="statistics-note">Statistiken omfattar aktiva och arkiverade grupper du har tillgång till. Borttagna grupper och borttagna utgifter räknas inte.</p>
  </section>;
}
