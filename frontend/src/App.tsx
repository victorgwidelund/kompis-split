...
export default function App() {
  ...
  const [globalDialog, setGlobalDialog] = useState<"trip" | "quick" | "friend" | "bug" | null>(null); const [tripDialog, setTripDialog] = useState<TripDialog>(null); const [editingExpense, setEditingExpense] = useState<Expense | null>(null); const [editingExpenseReadOnly, setEditingExpenseReadOnly] = useState(false); const [paymentPreset, setPaymentPreset] = useState<PaymentPreset | null>(null); const [categoryOpen, setCategoryOpen] = useState(false); const [quickInvitation, setQuickInvitation] = useState<InvitationResult | null>(null); const [toast, setToast] = useState("");
