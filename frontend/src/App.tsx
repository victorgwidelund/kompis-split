...
export default function App() {
  ...
  <Shell user={shellUser} version={version} trips={dashboard?.trips || []} view={view} guestMode={guestMode} onNavigate={(next) => void navigate(next)} onNewTrip={() => setGlobalDialog("trip")} onNewQuickTab={() => setGlobalDialog("quick")} onLogout={() => void api("/api/logout", { method: "POST", body: {} }).then(() => location.reload())}>
